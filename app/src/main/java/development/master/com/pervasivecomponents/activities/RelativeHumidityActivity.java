...
public class RelativeHumidityActivity extends AppCompatActivity implements SensorEventListener {
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            title.setText(getString(R.string.relative_humidity_activity));
